...
Set-EnvVarIfNotSet -var "KUBECONFIG" -defaultValue "C:/etc/kubernetes/kubelet.conf"

Set-EnvVarIfNotSet -var "CNI_BIN_DIR" -defaultValue "C:/opt/cni/bin"
Set-EnvVarIfNotSet -var "CNI_CONF_DIR" -defaultValue "C:/etc/cni/net.d"
